...
<div class="col-lg-12">
	<div class="card card-outline card-warning">
		...
		<div class="card-body">
			...
			<div class="form-group">
					<label for="home_quote" class="control-label">Website Home Quote</label>
			...
			<div class="form-group">
					<label for="intro" class="control-label">Chatbot Intro</label>
					<input type="text" class="form-control form-control-sm" name="intro" id="intro" value="<?php echo $_settings->info('intro') ?>">
			    </div>
			<div class="form-group">
