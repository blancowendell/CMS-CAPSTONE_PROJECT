...
<div class="card card-outline card-warning">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=responses/manage" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Create New</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-primary dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  		Action
...
<script>
	...
	function delete_question($id){
		start_loader();
		$.ajax({
			url:_base_url_+"classes/Chatbot.php?f=delete_response",
			method:"POST",
			data:{id: $id},
			error:err=>{
				console.log(err)
