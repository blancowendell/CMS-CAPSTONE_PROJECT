    ...
    <div class="w-100 row row-cols-1 row-cols-sm-1 row-cols-lg-3 row-cols-md-3 gx-3">
        ...
        <div class="col">
            <div class="card d-flex">
                <span class="schedule-holder bg-dark"><?php echo date("M d", strtotime($row['schedule'])) ?></span>
                <img src="<?php echo validate_image($row['img_path']) ?>" alt="<?php echo $row['img_path'] ?>" class="img-top img-thumb">
                    ...
                    <a href="javascript:void(0)" class="read_more btn btn-warning btn-sm btn-info" data-id="<?php echo $row['id'] ?>"><b>Read More</b></a>
                </div>
            </div>
        </div>
    </div>
