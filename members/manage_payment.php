    ...
    <form action="" id="transaction_form">
        <fieldset id="information">
            ...
            <div class="form-group">
                <label for="company_id" class="control-label text-info">Mode of Payment</label>
            ...
            <div class="form-group">
                ...
                <input name="amount_to_pay" id="amount_to_pay" class="form-control form-control-border text-right" required/>
            </div>
        </fieldset>
        ...
        <div class="form-group">
            <div class="col-12">
                <div class="d-flex justify-content-end align-items-center">
                    <button class="btn btn-warning btn-flat mr-2 d-none" type="button" id="back">Back</button>
                    <button class="btn btn-warning btn-flat mr-2" type="button" id="next">Next</button>
...
<script>
    ...
    env: 'sandbox', // change for production if app is live,
	  ...
	  client: {
        // for test only
        sandbox:    'Aej_PawICKL7IaFDvKcrPA6s1mrPgVyINAUkhdgeKqpbsKLZsxJI04aA2sf1_kUelSm3wFq229hYP65r',
        // for live only
        production: 'AfHsphgwSxTIY8_rqfWcO6-KdPZbAdlje8IldfD0vc-U4sIIBBYCxhiNg2vQgGwojVF4PP3xaOoB7tD5'
    },
