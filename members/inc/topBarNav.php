<nav class="navbar navbar-expand-lg navbar-dark bg-navy bg-gradient sticky-top">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="navbar-nav ml-auto d-flex align-items-center">
                      <?php if(isset($_SESSION['userdata']['id']) && $_settings->userdata('type') == 2): ?>
                        ...
                        <?php else: ?>
                        <a class="btn btn-primary text-light ml-2" id="login-btn" href="./login.php">Login</a>
                        <button onclick="location.href='/charity/';" class="btn btn-warning text-light ml-2" class="float-left" >Go to Home Page</button>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
