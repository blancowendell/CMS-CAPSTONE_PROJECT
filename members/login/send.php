...
$mail->SMTPAuth = true;
$mail->Username = 'lionsclubsanpedrod301a2@gmail.com';  // Replace with your email
$mail->Password = 'vhjoxdqinycvlevd';  // Replace with your email password
$mail->SMTPSecure = 'tls';
$mail->Port = 587;
...
// Other mail settings
$mail->setFrom('lionsclubsanpedrod301a2@gmail.com', 'SPLC');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['email'])) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        $mail->isHTML(true);
        $mail->Body = 'Click the following link to reset your password: <a href="http://localhost/charity/members/login/resetpass.php?token=' . $token . '">Reset Password</a>';
