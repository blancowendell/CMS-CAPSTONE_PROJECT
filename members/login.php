...
<body class="login-page  dark-mode py-4">
  ...
  <style>
    ...
    body:before{
        ...
        top:0;
        left:0;
        background-image: url("uploads/events/6.jpg");
   ...
   <img src="<?php echo validate_image($_settings->info('logo')) ?>" width="150" height="150" class="d-inline-block align-top" alt="" loading="lazy">
  <h1 class="text-center py-5 login-title"><b><?php echo $_settings->info('name') ?></b></h1>
<div class="login-box">
    <div class="card card-warning card-outline card-tabs bg-dark-gradient">
        ...
        <div class="tab-content" id="CTabContent">
            <div class="tab-pane fade active show" id="login" role="tabpanel" aria-labelledby="login-tab">
                ...
                <form id="ulogin-frm" action="" method="post">
                    ...
                    <div class="col-8">
                    <div class="col-8">
                        <a href="/charity">Go to Website</a>
                    </div>
                    </div>
                    <!-- /.col -->
                    <div class="col-4">
                    ...
                    <p class="mb-1">
                      <a href="login/forgotpass.php">I forgot my password</a>
                    </p>
                   </div>
                </form>
               ...
               <form action="" id="user-register">
                   ...
                   <div class="row">
                       <div class="col-md-12 text-center">
                        <button type="submit" class="btn btn-warning btn-lg rounded-pill w-50">Register</button>
                       </div>
                   </div>
               </form>
            </div>
