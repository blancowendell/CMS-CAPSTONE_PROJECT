    ...
    <div class="card card-outline card-warning">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-warning"><span class="fas fa-plus"></span>  New Payment</a>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center">
                                    <button type="button" class="btn btn-flat btn-warning btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
                                            Action
